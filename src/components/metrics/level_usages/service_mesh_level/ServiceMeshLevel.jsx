...
import ServiceMeshCard from "./ServiceMeshCard";

const ServiceMeshLevel = ({ data = [], isConnected = false, error = null }) => {
  ...
  return (
    <div className="flex flex-col flex-1 gap-4 p-6">
      ...
      <div className="flex-1">
        {viewMode === "table" && <ServiceMeshLevelTable data={data} />}
        {viewMode === "card" && <ServiceMeshCard data={data} />}
        {viewMode === "graph" && <ServiceMeshLevelGraph data={data} />}
      </div>
    </div>
  );
};
