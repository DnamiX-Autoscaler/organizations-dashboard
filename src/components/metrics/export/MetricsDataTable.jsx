...
import { fullMockMetricsData } from "../../../data/metricsExport";
...
const MetricsDataTable = () => {
    ...
    const currentRecords = fullMockMetricsData.slice(indexOfFirstRecord, indexOfLastRecord);
    const totalPages = Math.ceil(fullMockMetricsData.length / recordsPerPage);
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-white border border-gray-200 rounded-lg dark:bg-darkBackground dark:border-gray-700">
                <div className="text-sm text-gray-600 dark:text-gray-400">
                    Showing {indexOfFirstRecord + 1} to {Math.min(indexOfLastRecord, fullMockMetricsData.length)} of {fullMockMetricsData.length} records
                </div>
