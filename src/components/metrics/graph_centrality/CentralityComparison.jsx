        ...
        <div className="p-6 bg-white border border-gray-200 rounded-lg dark:bg-darkBackground dark:border-gray-700">
            ...
            <div className="mb-6">
                <p className="mb-3 text-sm text-gray-500 dark:text-gray-400">
                    Select up to 3 services to compare (Currently: {selectedServices.length}/3)
                </p>
                <div className="flex flex-wrap gap-2">
                    {services.map((service, index) => (
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium rounded-lg transition-all ${selectedServices.includes(service.id)
                                    ? `text-white`
                            ...
                            style={
                                selectedServices.includes(service.id)
                                    ? { backgroundColor: colors[selectedServices.indexOf(service.id)] }
                                    : {}
                            }
                        >
                            {service.name}
