...
const ResourceCard = ({
    ...
    <div
        onClick={onClick}
        className={`flex items-center gap-3 p-3 bg-white border rounded-lg cursor-pointer dark:bg-darkBackground transition-all ${isSelected
                ? `border-${borderColor} dark:border-${borderColor} bg-${bgColor} dark:bg-${bgColor.replace('50', '900/20')}`
