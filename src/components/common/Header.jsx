        ...
        <div className="relative">
          <button className="flex items-center justify-center w-10 h-10 transition-colors duration-200 bg-white border border-gray-300 rounded-full dark:bg-darkBackground dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-darkBackgroundVery">
            <Icon
              ...
              className="w-5 h-5 text-gray-400 dark:text-gray-300"
            />
            <span className="absolute flex items-center justify-center w-5 h-5 text-[10px] text-white bg-green-500 border-2 border-white dark:border-gray-900 rounded-full -top-1 -right-1">
              10
            </span>
          </button>
        </div>
        ...
        <div className="relative">
          <button className="flex items-center justify-center w-10 h-10 transition-colors duration-200 bg-white border border-gray-300 rounded-full dark:bg-darkBackground dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-darkBackgroundVery">
            <Icon
              ...
              className="w-5 h-5 text-gray-400 dark:text-gray-300"
            />
            <span className="absolute flex items-center justify-center w-5 h-5 text-[10px] text-white bg-[#F5A700] border-2 border-white dark:border-gray-900 rounded-full -top-1 -right-1">
              10
            </span>
          </button>
        </div>
        ...
        <div className="relative">
          <button className="flex items-center justify-center w-10 h-10 transition-colors duration-200 bg-white border border-gray-300 rounded-full dark:bg-darkBackground dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-darkBackgroundVery">
            <Icon
              ...
              className="w-5 h-5 text-gray-400 dark:text-gray-300"
            />
            <span className="absolute flex items-center justify-center w-5 h-5 text-[10px] text-white bg-red-500 border-2 border-white dark:border-gray-900 rounded-full -top-1 -right-1">
              10
            </span>
          </button>
        </div>
